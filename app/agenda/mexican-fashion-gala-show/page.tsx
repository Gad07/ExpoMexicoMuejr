                ...
                <Link href={`/expositores/${designer.slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  ...
                  onMouseOut={(e) => {
                    ...
                    <div style={{ height: '160px', width: '100%', position: 'relative', background: '#f0f0f0' }}>
                      <img src={designer.cover} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" width="600" height="400" />
                    ...
                    <div style={{ 
                      ...
                      <img src={designer.photo} alt={designer.name} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} loading="lazy" width="120" height="120" />
                    </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '64px', alignItems: 'center', marginBottom: '100px', borderTop: '1px solid rgba(0,0,0,0.08)', paddingTop: '80px' }}>
          ...
          <Reveal delay={200}>
            <div style={{ position: 'relative', borderRadius: '32px', overflow: 'hidden', height: '420px', boxShadow: '0 20px 40px rgba(0,46,81,0.06)' }}>
              <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=800" alt="Pasarelas" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" width="800" height="600" />
            </div>
          </Reveal>
        </div>
