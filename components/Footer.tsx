        ...
        <div className="v2-footer__inner">
          ...
          <div className="v2-footer__col">
            ...
            <nav className="v2-footer__links">
              ...
              <Link href="/patrocinadores" className="v2-footer__link">Patrocinadores</Link>
              <Link href="/invitados" className="v2-footer__link">Invitados Especiales</Link>
            </nav>
          </div>

          <div className="v2-footer__col">
            <span className="v2-footer__col-title">Actividades</span>
            <nav className="v2-footer__links">
              ...
              <Link href="/visa" className="v2-footer__link">Servicios Migratorios</Link>
            </nav>
          </div>
          ...
          <div className="v2-footer__col">
            ...
            <nav className="v2-footer__links">
              ...
              <a href="https://expomexico.ca/" className="v2-footer__link" target="_blank" rel="noopener noreferrer">Sitio Oficial</a>
            </nav>
