        ...
        <div className="v2-footer__top">
          <div className="v2-footer__inner">
            ...
            <div className="v2-footer__brand">
              <img src="/logo-emm.png" alt="Expo México Mujer" className="v2-footer__logomark" />
      ...
      <div className="footer__top">
        <div className="footer__inner">
          ...
          <div className="footer__brand">
            <img src="/logo-emm.png" alt="Expo México Mujer" className="footer__logomark" />
          ...
          <div className="footer__col">
            ...
            <nav className="footer__links" aria-label="Navegación Actividades">
              ...
              <Link href="/visa" className="footer__link">Tramita tu Visa</Link>
            </nav>
          </div>
